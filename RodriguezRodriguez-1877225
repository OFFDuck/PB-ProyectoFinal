...
int main() {
	...
	while (true) {
		...
		case 1:
			...
			cout << "Digite la hora de la cita en formato de 24 horas (Por ejemplo 13:00): ";
			cin >> hora;
			...
			cout << "Digite cuanto sera el precio unitario? (Por ejemplo 300)";
			cin >> precio;

			cout << "Digite cual sera la cantidad del tratamiento? (Por ejemplo 2)";
			cin >> cantidad;
